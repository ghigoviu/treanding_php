                                                    ...
                                                    <div class="card-body border-top p-9">
                                                            ...
                                                            <div class="col-lg-8">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 fv-row">
                                                                        <select name="day" aria-label="Select a day" data-control="select2" data-placeholder="Select a day..." class="form-select form-select-solid form-select-lg fw-semibold">
                                                                    ...
                                                                    <!--begin::Col-->
                                                                    <div class="col-lg-4 fv-row">
                                                                        <select name="year" aria-label="Select a year" data-control="select2" data-placeholder="Select a year..." class="form-select form-select-solid form-select-lg fw-semibold">
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <div class="col-lg-8 fv-row">
                                                                <textarea name="description" class="form-control form-control-lg form-control-solid" id=""></textarea>
                                                        ...
                                                        <div class="row mb-6">
                                                            <!--begin::Label-->
                                                            <label class="col-lg-4 col-form-label required fw-semibold fs-6">Hashtags</label>
                                                            <!--end::Label-->
                                                            <!--begin::Col-->
                                                            <div class="col-lg-8 fv-row">
                                                                <input class="form-control form-control-lg form-control-solid" name="tags" value="tag1, tag2, tag3" id="kt_tagify_1"/>
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="row mb-6">
                                                            ...
                                                            <!--begin::Col-->
                                                            <div class="col-lg-8 fv-row">
                                                                <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="jondoe@example.com"  />
                                                            </div>
                                                            <!--end::Col-->
                                                        </div>
                                                        <!--end::Input group-->
