				...
				<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
					...
					<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
						...
						<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
							...
							<!--end::Item-->
							<!--begin::Item-->
							<li class="breadcrumb-item text-muted">Seguidores</li>
							<!--end::Item-->
						</ul>
						<!--end::Breadcrumb-->
					</div>
					...
					<div class="d-flex flex-row">
								...
								<div class="card-body pt-15 px-0">
									...
									<div class="row px-9 mb-4">
										...
										<div class="col-md-4 text-center">
											...
											<span class="text-gray-500 fs-8 d-block fw-bold">SEGUIDORES</span>
										</div>
										<!--end::Col-->
										<!--begin::Col-->
										<div class="col-md-4 text-center">
											...
											<span class="text-gray-500 fs-8 d-block fw-bold">SIGUIENDO</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Row-->
							...
							<div class="card card-flush">
								...
								<div class="card-header pt-5">
									...
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold text-gray-900">Actividades</span>
										<span class="text-gray-500 pt-2 fw-semibold fs-6">Ultimas actividades</span>
									</h3>
									<!--end::Title-->
									<!--begin::Toolbar-->
						...
						<div class="w-100 flex-lg-row-fluid mx-lg-8">
							...
							<div class="d-flex flex-wrap flex-stack mb-6">
								<!--begin::Title-->
								<h3 class="text-gray-800 fw-bold my-2">Mis conexiones
						...
						<div class="d-lg-flex flex-column flex-lg-row-auto w-lg-300px" data-kt-drawer="true" data-kt-drawer-name="end-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '250px': '300px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_social_end_sidebar_toggle">
							...
							<div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										...
										<span class="text-muted mt-1 fw-semibold fs-7">8k visitantes</span>
									</h3>
									<!--begin::Toolbar-->
									<div class="card-toolbar">
										<!--begin::Menu-->
							...
							<div class="card card-flush mb-5 mb-xl-8">
								...
								<div class="card-header pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bold text-gray-900">Feeds en tendencias</span>
